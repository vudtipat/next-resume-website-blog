    ...
    return (
        <div className='flex flex-col relative'>
            <div className="py-[10px] px-0 md:px-[30px] flex items-center justify-between h-[10vh] border-b border-green-900/10">
                <span className='py-[14px] px-4 md:px-[30px] text-[#333] no-underline font-[800] text-2xl'>VudtipatSai</span>        
            ...
            {
                showMenu ? (
                    <div className='flex flex-col absolute w-[100%] top-[10vh] bg-white'>
